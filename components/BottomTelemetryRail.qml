    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Text {
                ...
                color: modelData === root.gear.toUpperCase() ? colors.copperBright : colors.textMuted
    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                width: 8
                height: 4
                color: index < Math.round(root.batterySoc * 42 / 100) ? colors.copperBright : colors.lineDim
